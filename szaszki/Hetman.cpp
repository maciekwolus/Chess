...
void Hetman::ruch(Figura* Bierki[], string str, int n, bool& poprawnosc, int czyjRuch, int &pomocN, double tablicaBytow[8][8])
{
	if (Bierki[n]->kolor == "Bialy" && czyjRuch % 2 == 0)
	{
		...
		//gora w prawo
		if (int(str[3]) - 48 == Bierki[n]->y + 1 && str[2] == Bierki[n]->x + 1
			&& tablicaBytow[8 - Bierki[n]->y - 1][int(Bierki[n]->x) - 97 + 1] <= 0)
		{
			skracaczBialy(Bierki, str, poprawnosc, pomocN, n);
		}
		else if (int(str[3]) - 48 == Bierki[n]->y + 2 && str[2] == Bierki[n]->x + 2
			&& tablicaBytow[8 - Bierki[n]->y - 1][int(Bierki[n]->x) - 97 + 1] == 0
			&& tablicaBytow[8 - Bierki[n]->y - 2][int(Bierki[n]->x) - 97 + 2] <= 0)
		{
			skracaczBialy(Bierki, str, poprawnosc, pomocN, n);
		}
		else if (int(str[3]) - 48 == Bierki[n]->y + 3 && str[2] == Bierki[n]->x + 3
			&& tablicaBytow[8 - Bierki[n]->y - 1][int(Bierki[n]->x) - 97 + 1] == 0
			&& tablicaBytow[8 - Bierki[n]->y - 2][int(Bierki[n]->x) - 97 + 2] == 0
			&& tablicaBytow[8 - Bierki[n]->y - 3][int(Bierki[n]->x) - 97 + 3] <= 0)
		{
			skracaczBialy(Bierki, str, poprawnosc, pomocN, n);
		}
		else if (int(str[3]) - 48 == Bierki[n]->y + 4 && str[2] == Bierki[n]->x + 4
			&& tablicaBytow[8 - Bierki[n]->y - 1][int(Bierki[n]->x) - 97 + 1] == 0
			&& tablicaBytow[8 - Bierki[n]->y - 2][int(Bierki[n]->x) - 97 + 2] == 0
			&& tablicaBytow[8 - Bierki[n]->y - 3][int(Bierki[n]->x) - 97 + 3] == 0
			&& tablicaBytow[8 - Bierki[n]->y - 4][int(Bierki[n]->x) - 97 + 4] <= 0)
		{
			skracaczBialy(Bierki, str, poprawnosc, pomocN, n);
		}
		else if (int(str[3]) - 48 == Bierki[n]->y + 5 && str[2] == Bierki[n]->x + 5
			&& tablicaBytow[8 - Bierki[n]->y - 1][int(Bierki[n]->x) - 97 + 1] == 0
			&& tablicaBytow[8 - Bierki[n]->y - 2][int(Bierki[n]->x) - 97 + 2] == 0
			&& tablicaBytow[8 - Bierki[n]->y - 3][int(Bierki[n]->x) - 97 + 3] == 0
			&& tablicaBytow[8 - Bierki[n]->y - 4][int(Bierki[n]->x) - 97 + 4] == 0
			&& tablicaBytow[8 - Bierki[n]->y - 5][int(Bierki[n]->x) - 97 + 5] <= 0)
		{
			skracaczBialy(Bierki, str, poprawnosc, pomocN, n);
		}
		else if (int(str[3]) - 48 == Bierki[n]->y + 6 && str[2] == Bierki[n]->x + 6
			&& tablicaBytow[8 - Bierki[n]->y - 1][int(Bierki[n]->x) - 97 + 1] == 0
			&& tablicaBytow[8 - Bierki[n]->y - 2][int(Bierki[n]->x) - 97 + 2] == 0
			&& tablicaBytow[8 - Bierki[n]->y - 3][int(Bierki[n]->x) - 97 + 3] == 0
			&& tablicaBytow[8 - Bierki[n]->y - 4][int(Bierki[n]->x) - 97 + 4] == 0
			&& tablicaBytow[8 - Bierki[n]->y - 5][int(Bierki[n]->x) - 97 + 5] == 0
			&& tablicaBytow[8 - Bierki[n]->y - 6][int(Bierki[n]->x) - 97 + 6] <= 0)
		{
			skracaczBialy(Bierki, str, poprawnosc, pomocN, n);
		}
		else if (int(str[3]) - 48 == Bierki[n]->y + 7 && str[2] == Bierki[n]->x + 7
			&& tablicaBytow[8 - Bierki[n]->y - 1][int(Bierki[n]->x) - 97 + 1] == 0
			&& tablicaBytow[8 - Bierki[n]->y - 2][int(Bierki[n]->x) - 97 + 2] == 0
			&& tablicaBytow[8 - Bierki[n]->y - 3][int(Bierki[n]->x) - 97 + 3] == 0
			&& tablicaBytow[8 - Bierki[n]->y - 4][int(Bierki[n]->x) - 97 + 4] == 0
			&& tablicaBytow[8 - Bierki[n]->y - 5][int(Bierki[n]->x) - 97 + 5] == 0
			&& tablicaBytow[8 - Bierki[n]->y - 6][int(Bierki[n]->x) - 97 + 6] == 0
			&& tablicaBytow[8 - Bierki[n]->y - 7][int(Bierki[n]->x) - 97 + 7] <= 0)
		{
			skracaczBialy(Bierki, str, poprawnosc, pomocN, n);
		}
		//gora lewo
...
void Hetman::szach(Figura* Bierki[], int n, bool& Szach, int c, double tablicaBytow[8][8], int i)
{
	//gora i dol
	if (Bierki[i]->x == Bierki[c]->x)
	{
			...
			&& tablicaBytow[8 - Bierki[i]->y - 3][int(Bierki[i]->x) - 97] == 0)
		{
			...
			&& tablicaBytow[8 - Bierki[n]->y - 1][int(Bierki[i]->x) - 97] == 0
			&& tablicaBytow[8 - Bierki[n]->y - 2][int(Bierki[i]->x) - 97] == 0
			&& tablicaBytow[8 - Bierki[n]->y - 3][int(Bierki[i]->x) - 97] == 0
			&& tablicaBytow[8 - Bierki[n]->y - 4][int(Bierki[i]->x) - 97] == 0)
		{
			Szach = true;
		}
	...
	//prawo gora
	if (Bierki[i]->x + 1 == Bierki[c]->x && Bierki[i]->y + 1 == Bierki[c]->y)
	{
		Szach = true;
	}
	else if (Bierki[i]->x + 2 == Bierki[c]->x && Bierki[i]->y + 2 == Bierki[c]->y
		&& tablicaBytow[8 - Bierki[i]->y - 1][int(Bierki[i]->x) - 97 + 1] == 0)
	{
		Szach = true;
	}
	else if (Bierki[i]->x + 3 == Bierki[c]->x && Bierki[i]->y + 3 == Bierki[c]->y
		&& tablicaBytow[8 - Bierki[i]->y - 1][int(Bierki[i]->x) - 97 + 1] == 0
		&& tablicaBytow[8 - Bierki[i]->y - 2][int(Bierki[i]->x) - 97 + 2] == 0)
	{
		Szach = true;
	}
	else if (Bierki[i]->x + 4 == Bierki[c]->x && Bierki[i]->y + 4 == Bierki[c]->y
		&& tablicaBytow[8 - Bierki[i]->y - 1][int(Bierki[i]->x) - 97 + 1] == 0
		&& tablicaBytow[8 - Bierki[i]->y - 2][int(Bierki[i]->x) - 97 + 2] == 0
		&& tablicaBytow[8 - Bierki[i]->y - 3][int(Bierki[i]->x) - 97 + 3] == 0)
	{
		Szach = true;
	}
	else if (Bierki[i]->x + 5 == Bierki[c]->x && Bierki[i]->y + 5 == Bierki[c]->y
		&& tablicaBytow[8 - Bierki[i]->y - 1][int(Bierki[i]->x) - 97 + 1] == 0
		&& tablicaBytow[8 - Bierki[i]->y - 2][int(Bierki[i]->x) - 97 + 2] == 0
		&& tablicaBytow[8 - Bierki[i]->y - 3][int(Bierki[i]->x) - 97 + 3] == 0
		&& tablicaBytow[8 - Bierki[i]->y - 4][int(Bierki[i]->x) - 97 + 4] == 0)
	{
		Szach = true;
	}
	else if (Bierki[i]->x + 6 == Bierki[c]->x && Bierki[i]->y + 6 == Bierki[c]->y
		&& tablicaBytow[8 - Bierki[i]->y - 1][int(Bierki[i]->x) - 97 + 1] == 0
		&& tablicaBytow[8 - Bierki[i]->y - 2][int(Bierki[i]->x) - 97 + 2] == 0
		&& tablicaBytow[8 - Bierki[i]->y - 3][int(Bierki[i]->x) - 97 + 3] == 0
		&& tablicaBytow[8 - Bierki[i]->y - 4][int(Bierki[i]->x) - 97 + 4] == 0
		&& tablicaBytow[8 - Bierki[i]->y - 5][int(Bierki[i]->x) - 97 + 5] == 0)
	{
		Szach = true;
	}
	else if (Bierki[i]->x + 7 == Bierki[c]->x && Bierki[i]->y + 7 == Bierki[c]->y
		&& tablicaBytow[8 - Bierki[i]->y - 1][int(Bierki[i]->x) - 97 + 1] == 0
		&& tablicaBytow[8 - Bierki[i]->y - 2][int(Bierki[i]->x) - 97 + 2] == 0
		&& tablicaBytow[8 - Bierki[i]->y - 3][int(Bierki[i]->x) - 97 + 3] == 0
		&& tablicaBytow[8 - Bierki[i]->y - 4][int(Bierki[i]->x) - 97 + 4] == 0
		&& tablicaBytow[8 - Bierki[i]->y - 5][int(Bierki[i]->x) - 97 + 5] == 0
		&& tablicaBytow[8 - Bierki[i]->y - 6][int(Bierki[i]->x) - 97 + 6] == 0)
	{
		Szach = true;
	}
	//lewo gora
	else if (Bierki[i]->x - 1 == Bierki[c]->x && Bierki[i]->y + 1 == Bierki[c]->y)
	{
		Szach = true;
	}
	else if (Bierki[i]->x - 2 == Bierki[c]->x && Bierki[i]->y + 2 == Bierki[c]->y
...
void Hetman::mozliwyRuch(Figura* Bierki[], int czyjRuch, int& NBialychRuchow, int& NCzarnychRuchow, int n, string str, Sprite Obrazki[], bool& bialyMat, bool& bialyPat, bool& czarnyPat, bool& czarnyMat)
{
